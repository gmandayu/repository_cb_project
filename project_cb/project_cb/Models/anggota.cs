...
namespace project_cb.Models
{
    class anggota
    {
        private string id, nama_lengkap, nama_panggilan, jenis_kelamin,
            status_perkawinan, tempat_lahir, /*tanggal_lahir,*/ agama, alamat_lengkap, telepon;
        private string jenis_identitas, no_identitas, pendidikan, pekerjaan, tempat_bekerja, alamat_pekerjaan,
